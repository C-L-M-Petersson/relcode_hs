...
mElement :: QNum -> QNum -> QNum -> QNum -> Int -> CDict -> IO [String]
...
--            | otherwise                      = -1
--        colInner
--            | kappa2==  kappa1-signum kappa0 =  1
--            | kappa2== -kappa1               =  2
--            | kappa2==  kappa1+signum kappa0 =  3
--            | otherwise                      = -1
--
--
--
...
--
--
--mElement :: QNum -> QNum -> QNum -> QNum -> Int -> CDict -> IO [Double]
--mElement kappa0 n0 kappa1 kappa2 eFinalIndex = (filterLines<$>).readFileColKappa
--    ("m_elements_eF"++show eFinalIndex++"_"++show kappa0
--                                      ++"_"++show (nthKappaElevel kappa0 n0))
--        kappa0 kappa1 kappa2
